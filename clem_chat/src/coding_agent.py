...
class Agent:
    ...
    def get_prompt_category(self, user_prompt) -> str:
        ...
        elif bool(re.search(r'use designer', user_prompt, re.IGNORECASE)):
            self.logger.log_debug(f"Agent will use Front end Designer for LLMS")
            return self.sys_prompt.SYSTEM_PROMPT_DESIGNER()
